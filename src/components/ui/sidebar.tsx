...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md p-3 text-left text-sm font-medium outline-none ring-sidebar-ring transition-all focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      isActive: {
...
>(({ asChild = false, isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-9 min-w-0 items-center gap-2 overflow-hidden rounded-md px-3 text-sidebar-foreground/80 outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50',
...
// Dummy components to avoid breaking changes
const SidebarClose = React.Fragment;
